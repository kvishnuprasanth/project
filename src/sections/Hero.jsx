...
const Hero = () => {
  ...
  return (
    <section 
      ...
      justify-center min-h-screen gap-10 max-container border-2 "
      
    >
      <div className="relative xl:w-2/5 flex-col justify-center items-start
      ...
      xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        ...
        />
        <div className="flex sm:gap gap-6 absolute -bottom-[5%]
